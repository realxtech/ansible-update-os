...
Var           |INFO
--------------|------------------------------------------------------------------------------------
exclude       |Список исклучений, записывается как масив разделенный запятыми. *Значения строчные*.
security      |ЭКСПЕРЕМЕНТАЛЬНЫЙ! Установка только обновлений безопасности. *Значение булево*.
need_reboot   |Перезагрузка желательна, но необязательна. *Значение булево*.
